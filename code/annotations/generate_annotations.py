#!/usr/bin/env python
"""Generate annotated BIDS event files for the mariostars dataset.
...
Usage:
    python generate_annotations.py -d /path/to/mariostars
...
def main() -> int:
    ...
    parser.add_argument("-d", "--datapath", default=".",
                        help="Root of the mariostars dataset.")
